...
\begin{figure} % opens the figure environment. the '[H]' forces the image to be Here
    ...
    \caption[Summary of the OSHDB data model]{Summary of the OSHDB data model, provided by \textcite{raifer_oshdb_2019}.} % this prints the caption below the figure
