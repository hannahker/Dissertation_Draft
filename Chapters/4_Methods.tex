...
The information captured by these variables is diverse, encompassing numerical, spatial, temporal, and attributional information. While most variables are highly structured, the information contained within the \textit{Tags} variable requires significant cleaning to be useful. Across all case studies, I have collected data from 495,891 OSM entities. Many of these entities reflect modified versions of the entities created during each campaign. 
