...
\begin{figure}[H] % opens the figure environment. the '[H]' forces the image to be Here
    ...
    \includegraphics[width = \textwidth]{Images/components.PNG} %this tells latex what graphics to include. 
    \caption{Overview of the OSM's technical components \parencite{openstreetmap_wiki_component_2018}} % this prints the caption below the figure
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%
